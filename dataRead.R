...
AF16.2 <- two.d.array(readland.tps("preliminary\ images/20C/2-cell/AF16-2.tps", specID = "imageID"))
N2.2 <- two.d.array(readland.tps("preliminary\ images/20C/2-cell/N2-2.tps", specID = "imageID"))
...
AF16.new.2 <- two.d.array(readland.tps("images/20C/2-cell/AF16/AF16.tps", specID = "imageID"))
N2.new.2 <- two.d.array(readland.tps("images/20C/2-cell/N2/N2.tps", specID = "imageID"))


AF16.4 <- two.d.array(readland.tps("preliminary\ images/20C/4-cell/AF16-4.tps", specID = "imageID"))
N2.4 <- two.d.array(readland.tps("preliminary\ images/20C/4-cell/N2-4.tps", specID = "imageID"))
...
AF16.new.4 <- two.d.array(readland.tps("images/20C/4-cell/AF16/AF16.tps", specID = "imageID"))
N2.new.4 <- two.d.array(readland.tps("images/20C/4-cell/N2/N2.tps", specID = "imageID"))

cells.2 <- arrayspecs(rbind(AF16.2, N2.2), 12, 2)
cells.new.2 <- arrayspecs(rbind(AF16.new.2, N2.new.2), 12, 2)
cells.4 <- arrayspecs(rbind(AF16.4, N2.4), 18, 2)
cells.new.4 <- arrayspecs(rbind(AF16.new.4, N2.new.4), 18, 2)
sls.cells.2 <- arrayspecs(rbind(AF16.2[,c(1:8)], N2.2[,c(1:8)]), 4, 2)   #sliding-landmark-less
sls.cells.4 <- arrayspecs(rbind(AF16.4[,c(1:20)], N2.4[,c(1:20)]), 10, 2)
...
method <- as.factor(c(rep("old", length(cells.2[1,1,])), 
                       rep("new", length(cells.new.2[1,1,]))))



cells.2 <- arrayspecs(rbind(AF16.2, N2.2, AF16.new.2, N2.new.2), 12, 2)
cells.4 <- arrayspecs(rbind(AF16.4, N2.4, AF16.new.4, N2.new.4), 18, 2)
...
sls.2 <- gpagen(sls.cells.2, ProcD = T)#, PrinAxes = T)
sls.4 <- gpagen(sls.cells.4, ProcD = T)#, PrinAxes = T)
